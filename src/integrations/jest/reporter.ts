/* eslint-disable @typescript-eslint/interface-name-prefix, lines-between-class-members, @typescript-eslint/explicit-function-return-type */

// Shamelessly stolen from https://github.com/jonjaques/jest-nock-back/edit/master/src/reporter.ts
